...
import { MdWork } from "react-icons/md"; // Import icon for Education & Experience
import { GiTrophyCup } from "react-icons/gi"; // Icon for Honors & Awards
          ...
          <Nav className="ms-auto" defaultActiveKey="#home">
            ...
            <Nav.Item>
              <Nav.Link
                ...
                onClick={() => updateExpanded(false)}
              >
                <MdWork style={{ marginBottom: "2px" }} /> Education & Experience
              </Nav.Link>
            </Nav.Item>
